/**
 * Génère le PDF de l'exemple Parcours A (Audit d'un projet d'achat)
 * affiché sur /exemple-rapport.
 *
 * Usage : npx tsx scripts/generate-exemple.ts
 */
...
async function main() {
  ...
  const outPath = path.join(process.cwd(), 'public', 'exemples', 'rapport-exemple-anonymise.pdf')
